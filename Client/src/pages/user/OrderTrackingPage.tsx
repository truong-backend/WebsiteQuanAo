  ...
  return (
    <div className={styles.page}>
      ...
      <header className={styles.header}>
        ...
        <p>Theo dõi hành trình tuyệt tác của bạn từ xưởng chế tác đến tận tay.</p>
      </header>
          ...
          <div className={styles.formSupport}>
            ...
            <div className={styles.supportLinks}>
              <a href="/contact" className={styles.supportLink}>
                <span className={`material-symbols-outlined ${styles.supportIcon}`}>support_agent</span>
                <span>Liên hệ bộ phận Chăm sóc</span>
              </a>
              <a href="/shopping-guide" className={styles.supportLink}>
                <span className={`material-symbols-outlined ${styles.supportIcon}`}>help_outline</span>
          ...
          <div className={styles.statusCard}>
                ...
                {STEPS.map((step) => (
                  <div key={step.label} className={styles.stepperItem}>
                    <div className={`${styles.stepDot} ${styles[step.status]}`}>
                      <span className={`material-symbols-outlined ${styles.dotIcon}`}>
                        {step.icon}
                      </span>
                    </div>
                    <span className={`${styles.stepLabel} ${step.status === 'active' ? styles.activeLabel : ''}`}>
                      {step.label}
                    </span>
                  </div>
                ))}
            ...
            <div className={styles.shipmentMeta}>
              <div className={styles.metaItem}>
                ...
                <span className={styles.metaValue}>Standard Express International</span>
              </div>
              <div className={styles.metaItem}>
                <span className={styles.metaLabel}>Mã vận đơn</span>
                <span className={styles.metaValue}>
                  SE-AM-559021
                  <span className={`material-symbols-outlined ${styles.copyIcon}`}>content_copy</span>
                </span>
              </div>
            </div>
          </div>
