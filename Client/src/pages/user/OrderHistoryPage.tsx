        ...
        <section className={styles.content}>
          <div className={styles.inner}>
            ...
            <div className={styles.pageHeader}>
              <h1>Order History</h1>
              <p>
                Review and track your recent acquisitions from the Atelier. Each
                piece is crafted with intentionality and delivered with care.
              </p>
            </div>
                ...
                <div key={order.id} className={styles.orderCard}>
                  ...
                  <div className={styles.orderRight}>
                    <div className={styles.orderMeta}>
                      ...
                      <span
                        className={`${styles.badge} ${order.status === "Shipped" ? styles.shipped : styles.delivered}`}
                      >
                        {order.status}
                      </span>
                    </div>
                ...
                <div className={styles.careGrid}>
                  {CARE_TIPS.map((tip) => (
                    <div key={tip.title} className={styles.careCard}>
                      <span
                        className={`material-symbols-outlined ${styles.careIcon}`}
                      >
                        {tip.icon}
                      </span>
                      <h4>{tip.title}</h4>
