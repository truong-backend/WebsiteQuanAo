...
public class SecurityConfiguration {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // ⚠️ allowCredentials(true) is incompatible with a wildcard origin ("*").
        // Spring silently drops the Allow-Origin header when both are set together,
        // causing the CORS error. Always list origins explicitly when using credentials.
        configuration.setAllowedOrigins(List.of(
                "http://localhost:5173",
                "http://localhost:3000",
                "https://website-quan-ao.vercel.app"
        ));
