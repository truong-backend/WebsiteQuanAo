        ...
        <div className="container mx-auto px-6 max-w-screen-xl">
          <nav className="flex items-center justify-between h-16">
            ...
            >
              <span
                className={cn(
                  "h-px bg-brand-black transition-all duration-300",
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={openDrawer}
                className="relative flex items-center text-brand-mid hover:text-brand-black transition-colors"
                aria-label="Giỏ hàng"
              >
                <svg
                  className="w-5 h-5"
        ...
        >
          ...
          <div className="px-6 py-3 border-b border-brand-light">
            ...
            >
              ...
              <button
                type="submit"
                className="px-3 bg-brand-black text-brand-white text-xs"
              >
                Tìm
              </button>
            </form>
