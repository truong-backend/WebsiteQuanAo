...
// Moved from: src/pages/user/CartPage.tsx
// Changed imports: @/modules → ../hooks/useCart | @/types → ../types/cart.types
...
const CartPage: React.FC = () => {
  ...
  const { items, changeQty, removeItem, total, totalItems } = useCart();
