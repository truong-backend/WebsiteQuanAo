    ...
    {[1, 2, 3].map((i) => (
      <div key={i} className={styles.orderCard}>
        <div className={styles.orderLeft}>
          <div
            className={`${styles.orderThumb} ${styles["orderThumb--skeleton"]}`}
          />
...
const OrderCard: React.FC<{ order: OrderBasicResponse }> = ({ order }) => {
  const navigate = useNavigate();
    ...
    <div className={styles.orderCard}>
      <div className={styles.orderLeft}>
        ...
        <div className={styles.orderInfo}>
          ...
          <h3>{itemCount > 0 ? `${itemCount} sản phẩm` : "Đơn hàng"}</h3>
