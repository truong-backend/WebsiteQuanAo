...
import { LocalCartService } from '@/features/cart';
...
export function useProductListing() {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      const res = await ProductService.getProductsForListing(
        currentPage, PAGE_SIZE, searchQuery || undefined, categoryId,
  ...
  return {
    ...
    toastOpen, setToastOpen, toastProduct,
    addedIds,
    ...
    fetchProducts, handleReset, handleAddToCart,
    activeCategoryName,
  };
}
