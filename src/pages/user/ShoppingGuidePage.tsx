// src/pages/ShoppingGuidePage.tsx
// Moved from: src/pages/user/ShoppingGuidePage.tsx
  ...
  <PageLayout>
    <div className={styles.page}>
      <section className={styles.hero}>
        ...
        <p>
          Trải nghiệm mua sắm tại Atelier Monochrome được thiết kế để mang lại
          sự tĩnh lặng và tinh tế.
        </p>
      </section>
          ...
          <div className={styles.stepsGrid}>
            <div className={styles.stepsLeft}>
              <div className={styles.stepBlock}>
                ...
                <p>
                  Duyệt qua các danh mục được tuyển chọn. Mỗi bộ sưu tập tại
                  Atelier Monochrome là một câu chuyện về chất liệu và phom dáng
                  tối giản.
                </p>
              ...
              <div className={`${styles.stepBlock} ${styles.indented}`}>
                ...
                <p>
                  Xem lại các lựa chọn của bạn. Đảm bảo mọi chi tiết đều hoàn
                  hảo trước khi chúng tôi tiến hành chuẩn bị đóng gói thủ công.
                </p>
            ...
            <div className={styles.stepsRight}>
              <div className={`${styles.stepBlock} ${styles.autoRight}`}>
                ...
                <p>
                  Chọn kích cỡ phù hợp dựa trên bảng size chi tiết của chúng
                  tôi. Thêm vào túi đồ với sự tự tin về chất lượng bền vững.
                </p>
              ...
              <div className={`${styles.stepBlock} ${styles.maxWidth}`}>
                ...
                <p>
                  Chúng tôi cung cấp các phương thức thanh toán bảo mật đa dạng.
                  Nhập thông tin vận chuyển để nhận tạo tác tại nhà.
                </p>
                <div className={`${styles.stepImage} ${styles.aspectSquare}`}>
              ...
              <div className={`${styles.stepBlock} ${styles.autoRight}`}>
                ...
                <p>
                  Nhận mã theo dõi hành trình đơn hàng ngay sau khi thanh toán.
                  Sản phẩm sẽ sớm thuộc về bạn.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className={styles.tipsSection}>
        <div className={styles.tipsInner}>
          <div className={styles.tipsHeader}>
            ...
            <p>
              Đảm bảo mỗi món đồ bạn chọn đều mang lại sự hài lòng tuyệt đối.
            </p>
          </div>
        ...
        <div className={styles.ctaInner}>
          ...
          <div className={styles.ctaContent}>
            <div className={styles.ctaText}>
              <h2>Cần hỗ trợ?</h2>
              <p>
                Đội ngũ chăm sóc khách hàng của chúng tôi luôn túc trực để giải
                đáp mọi thắc mắc.
              </p>
            </div>
            <div className={styles.ctaButtons}>
              ...
              <button className={styles.ctaBtnSecondary}>
                ...
                <span className={styles.btnIcon}>0981907754</span>
              </button>
            </div>
          </div>
        </div>
