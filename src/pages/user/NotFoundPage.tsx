...
// Moved from: src/pages/user/NotFoundPage.tsx
// Static page — không đổi import nào
...
const NotFoundPage: React.FC = () => {
  ...
  return (
    <div className={styles.page}>
      <div className={styles.ghost}><span>404</span></div>
      <div className={styles.card}>
        ...
        <div className={styles.actions}>
          <Link to="/home" className={styles.btnPrimary}>Về trang chủ</Link>
          <button className={styles.btnSecondary} onClick={() => navigate(-1)}>Quay lại</button>
        </div>
      </div>
    </div>
  );
