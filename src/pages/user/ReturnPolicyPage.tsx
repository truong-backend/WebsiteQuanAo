...
// Moved from: src/pages/user/ReturnPolicyPage.tsx
...
const steps = [
  {
    label: "Gửi yêu cầu",
    desc: "Truy cập cổng thông tin đổi trả trên website hoặc gửi email trực tiếp cho đội ngũ chăm sóc khách hàng kèm mã đơn hàng.",
  },
  {
    label: "Xác nhận đơn hàng",
    desc: "Trong vòng 24 giờ làm việc, chúng tôi sẽ kiểm tra thông tin và gửi hướng dẫn chi tiết qua email.",
  },
  {
    label: "Vận chuyển",
    desc: "Đóng gói sản phẩm cẩn thận và gửi về kho trung tâm theo địa chỉ được cung cấp.",
  },
  {
    ...
    <div className={styles.page}>
      <header className={styles.hero}>
        ...
        <p>
          ...
          chỉ và cam kết mang lại sự hài lòng tuyệt đối cho quý khách.
        </p>
      </header>
      ...
      <section className={styles.exclusionsSection}>
        <div className={styles.exclusionsContent}>
          ...
          <p className={styles.exclusionsLead}>
            Để đảm bảo tính độc bản và vệ sinh, một số sản phẩm sẽ không được áp
            dụng chính sách đổi trả thông thường.
          </p>
        ...
        <div className={styles.exclusionsImage}>
          <img src={EXCLUSIONS_IMAGE} alt="Minimalist atelier interior" />
        </div>
      </section>
